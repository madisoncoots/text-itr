...
X <- c("Female", "Age", "PastFTA", "StatenIsland", "Bronx", "Brooklyn", "Queens", 
       "PastSummons", "MedianIncZip", "PctBlackZip", "PctHispZip", "PctBelowPovZip")

forest <- causal_forest(df[X], as.vector(df$success), as.vector(df$Treatment))
...
multi_arm <- multi_arm_causal_forest(df[X], as.vector(df$success), factor(treat_type))
